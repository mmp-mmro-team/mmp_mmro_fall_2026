...
| :---: | :---: | --- | --- | --- |
| 3 сентября  | Семинар 1 | Введение в курс. Pandas. Разведочный анализ данных |  | [Домашнее задание](https://github.com/mmp-mmro-team/mmp_mmro_fall_2026/blob/main/Homework1/numpy_pandas_matplotlib_2026.ipynb) |
| 10 сентября  | Семинар 2 | Метрическая парадигма машинного обучения. KNN. Проблемы метода и практические применения |  |  ¯\\\_(ツ)\_/¯ |
